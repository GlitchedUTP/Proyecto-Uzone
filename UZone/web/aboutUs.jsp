...
<div class="container">
    <div class="row">
        <div class="col-md-12 one-column-text">
            <h2>Quiénes somos</h2>
            <h3>Líderes y pioneros en la busqueda de interacción entre personas que ofrecen sus servicios ya sea artísticos o de cualquier otro tipo de entretenimiento.  </h3>
        </div>
    </div>
</div>
<div class="row photo-quote-left">
    <div class="col-md-6 quote-content-left">
         "En base a la tecnología, decidimos que la forma convensional de encontrar empresas y/o artistas, y que estos interactuen serìa el futuro."
        <p>”Nicolas <span>”CEO</span></p>
    </div>
</div>
<center>
